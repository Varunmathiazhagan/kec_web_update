...
// Stats Data
const stats = [
  { number: 1984, label: "Established", icon: Landmark },
  { number: 170, label: "Acre Green Campus", icon: Leaf },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <h3 className="text-4xl md:text-5xl font-bold text-blue-900 mb-2">{countedStats[index]}</h3>
